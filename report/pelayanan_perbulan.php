...
<html>
    <head>
        <title>Cetak Data Pelayanan Perbulan</title>
            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA PELAYANAN PERBULAN   <? echo "$bulanNama $ambilthn"; ?></h3>
                ...
                <th>No.</th><th>Nama</th><th>NIK</th><th>JENIS PELAYANAN</th><th>Tanggal</th><th>Keterangan</th>
                            ...
                            $sql = "SELECT * FROM pelayanan WHERE substr(tanggal,1,7)='$ambilthn-$ambilbln'";
